...
ADD CONSTRAINT fk_loan_apps_created_loan
FOREIGN KEY (created_loan_id)
...
-- ================================================================
--  SECTION 4 â€” STORED FUNCTIONS AND PROCEDURES
--  These routines are additive helpers for reporting and dashboards.
-- ================================================================
...
-- 7. All stored routines registered in this schema
SELECT
    ROUTINE_TYPE,
    ROUTINE_NAME
FROM information_schema.ROUTINES
WHERE ROUTINE_SCHEMA = 'financial_system'
